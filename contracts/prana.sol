...
contract prana is ERC721 {
    ...
    function viewRentingTokenDetails(uint256 _tokenId)
        public
        view
        returns (
            uint256,
    ...
    function tokenForResaleAtIndex(uint256 index)
        public
        view
        returns (uint256)
    {
    ...
    function tokenForRentingAtIndex(uint256 index)
        public
        view
        returns (uint256)
    {
    ...
    function tokenOfRenteeByIndex(address _rentee, uint256 index)
        public
        view
        returns (uint256)
    {
    ...
    function viewBookDetails(uint256 _isbn)
        public
        view
        returns (
            string memory,
    ...
    function viewMyBookDetails(uint256 _isbn)
        public
        view
        returns (
            string memory,
