...
contract PranaInterface {
    function buyToken(uint256 tokenid, address _tokenRecipient)
        public
        payable
    {}

    function buyTokenAsTheSpecialBuyer(uint256 tokenid, address _tokenRecipient)
        public
        payable
    {}
}
...
contract pranaHelper {
    constructor(address _pranaAddress) public {
        owner = msg.sender;
